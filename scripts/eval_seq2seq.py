...
if __name__ == '__main__':
    ...
    parser.add_argument('--sos', type=str, default='<go>', help='start token of the sentence')
    parser.add_argument('--eos', type=str, default='<eos>', help='end token of the sentence')
    parser.add_argument('--sep', type=str, default='<blank>', help='sep token of the sentence')
