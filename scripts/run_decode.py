...
if __name__ == '__main__':
    ...
    parser.add_argument('--step', type=int, default=500, help='if less than diffusion training steps, like 1000, use ddim sampling')
    ...
    for lst in glob.glob(args.model_dir):
        ...
        for checkpoint_one in checkpoints:
            ...
            COMMAND = f'python -m torch.distributed.launch --nproc_per_node=1 --master_port={12233 + int(args.seed)} --use_env sample_seq2seq_tae.py ' \
